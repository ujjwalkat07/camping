...
export async function PUT(
  ...
  try {
    ...
    const backendUrl = `https://project-camps.onrender.com/api/admin/bookings/${bookingId}/approve`;
    ...
    try {
      ...
      if (!response.ok) {
        return NextResponse.json(
          { success: false, message: data.message || data.error || 'Failed to approve booking on backend' },
